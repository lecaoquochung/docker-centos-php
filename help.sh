...
case $1 in
    ...
    latest)
        ...
        readonly LATEST_DOCKER_CENTOS="rsync -avz --exclude-from ${DOCKERCENTOS_PATH}/${PROJECT_NAME}/exclude.txt ${DOCKERCENTOS_PATH}/${PROJECT_NAME}/* ${DOCKERCENTOS_PATH}/"
    ...
    commit)
        ...
        readonly REVERSE_SYNC="rsync -ruvv --include-from=${DOCKERCENTOS_PATH}/${PROJECT_NAME}/commit.txt ${DOCKERCENTOS_PATH}/* ${DOCKERCENTOS_PATH}/${PROJECT_NAME}/"
    ...
    *)
        ...
        echo "Param:"
        echo "./dockercentos.sh [ps|up|down|db|ssh|build|log|restart|latest|commit]"
